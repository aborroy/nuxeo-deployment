...
<body>
  ...
  <script nonce="<%= NX_NONCE_VALUE %>">
    (function() {
      var importHref = 'nuxeo-custom-bundle.html';

      function loadCustomBundle() {
        if (document.querySelector('link[rel="import"][href="' + importHref + '"]')) {
          return;
        }
      ...
      if (window.customElements) {
        ...
        window.addEventListener('WebComponentsReady', loadCustomBundle, { once: true });
      }
    }());
  </script>
